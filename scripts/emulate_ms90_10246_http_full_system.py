#!/usr/bin/env python3
"""Run the isolated full-system HTTP lab against MS90 V1.0.2.46."""
...
LAB = ROOT / "known_firmware/emulation/MK93S/V1.0.2.46-full-system-http-lab"

lab.ROOTFS = Path(
    "/tmp/ms90-10246/extracted/"
    "_MS90-V1.0.2.46_1.0.42.chk.extracted/squashfs-root"
)
lab.LAB = LAB
lab.STAGING = Path("/tmp/friday-ms90-10246-http-full-system-root")
lab.INITRAMFS = LAB / "ms90-10246-http-rootfs.cpio.gz"
lab.SERIAL = LAB / "serial.log"
lab.QEMU_LOG = LAB / "qemu.log"
lab.PIDFILE = LAB / "qemu.pid"
lab.SECURITY_LOG = LAB / "http-security-probe.log"
lab.HOST_HTTP_PORT = 25_094
