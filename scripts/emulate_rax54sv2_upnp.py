#!/usr/bin/env python3
"""Launch and probe RAX54Sv2 V1.1.6.38 upnpd in an isolated container."""
...
ROOTFS = ROOT / "known_firmware/extracted/c9b1ed79f8f766b5/manual-rootfs"
WORK = Path("/tmp/rax54sv2-upnp-emulation")
CONTAINER = "rax54sv2-upnp-emulator"
PROBES = (
