// Dump decompiled functions that reference additional HTTP command-sink candidate strings.
...
public class GhidraXrefsExtra extends GhidraScript {
    private final String[] targets = {
        "genie_fix2.cgi", "wan_gateway", "wlg_adv.cgi", "apmode_gateway",
        "pppoe.cgi", "pppoe_localip", "operation_mode.cgi",
        "genieping.cgi", "genieping2.cgi", "genieping3.cgi", "genieping4.cgi",
        "rccommand.cgi", "rccommand_test.cgi", "targetTimezone"
    };
            ...
            for (MemoryBlock block : mem.getBlocks()) {
                ...
                for (int idx = indexOf(hay, needle, 0); idx >= 0; idx = indexOf(hay, needle, idx + 1)) {
                    ...
                    for (Reference ref : getReferencesTo(addr)) {
                        ...
                        println("  REF from " + ref.getFromAddress() + " func=" +
