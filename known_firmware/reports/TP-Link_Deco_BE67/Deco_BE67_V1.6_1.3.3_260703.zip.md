# Firmware Audit: TP-Link Deco BE67 / Deco_BE67_V1.6_1.3.3_260703.zip

- Source URL: https://static.tp-link.com/upload/firmware/2026/202607/20260723/Deco BE67_V1.6_1.3.3_260703.zip
- Local path: known_firmware/firmware/TP-Link_Deco_BE67/Deco_BE67_V1.6_1.3.3_260703.zip
- SHA-256: `dec7dfe068a6910bb5942ad201be8e7a952687b9e8b3dba64f1225379804ea12`
- Size: 50092326 bytes
- Version: V1.60_1.3.3 Build 260703
...
- `3/10`: rejected: route is not correlated with a dangerous sink; auth=unknown; evidence=L0; score=2
...
- `F/V`: rejected: route is not correlated with a dangerous sink; auth=unknown; evidence=L0; score=2
- `FlateDecode/I`: rejected: route is not correlated with a dangerous sink; auth=unknown; evidence=L0; score=2
- `Font/Subtype/TrueType/Name/F1/BaseFont/TimesNewRomanPS-BoldMT/Encoding/WinAnsiEncoding/FontDescriptor`: rejected: route is not correlated with a dangerous sink; auth=unknown; evidence=L0; score=2
- `Font/Subtype/TrueType/Name/F5/BaseFont/TimesNewRomanPSMT/Encoding/WinAnsiEncoding/FontDescriptor`: rejected: route is not correlated with a dangerous sink; auth=unknown; evidence=L0; score=2
- `Font/Subtype/TrueType/Name/F7/BaseFont/ArialMT/Encoding/WinAnsiEncoding/FontDescriptor`: rejected: route is not correlated with a dangerous sink; auth=unknown; evidence=L0; score=2
- `Font/Subtype/Type0/BaseFont/BCDEEE`: rejected: route is not correlated with a dangerous sink; auth=unknown; evidence=L0; score=2
...
Structured zero-day triage JSON: `known_firmware/reports/TP-Link_Deco_BE67/Deco_BE67_V1.6_1.3.3_260703.zip.zero-day.json`

## Extraction Notes

- binwalk -eM --directory known_firmware/extracted/dec7dfe068a6910b exited 0: WARNING: Extractor.execute failed to run external extractor 'unstuff '%e'': [Errno 2] No such file or directory: 'unstuff', 'unstuff '%e'' might not be installed correctly
