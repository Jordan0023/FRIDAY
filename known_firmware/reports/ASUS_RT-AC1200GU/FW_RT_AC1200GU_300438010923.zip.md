...
- `Advanced_Feedback.asp: desclist.push(["<#250#>","Firewall"]); //20`
...
Structured zero-day triage JSON: `known_firmware/reports/ASUS_RT-AC1200GU/FW_RT_AC1200GU_300438010923.zip.zero-day.json`

## Extraction Notes

- Using existing extraction directory: known_firmware/extracted/a934214ed8c70e50
