...
- `files/GDC/EXS25/EXS25-V1.0.1.34.zip`: rejected: route is not correlated with a dangerous sink; auth=unknown; evidence=L1; score=7
...
Structured zero-day triage JSON: `known_firmware/reports/EXS25/EXS25-V1.0.1.34.zip.zero-day.json`

## Extraction Notes

- Using existing extraction directory: known_firmware/extracted/44d8bbed150c5cb3
