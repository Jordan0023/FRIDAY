...
- `files/GDC/RAX54S/RAX54Sv2-V1.1.6.38.zip`: rejected: route is not correlated with a dangerous sink; auth=unknown; evidence=L0; score=2

### Non-HTTP Service Surface

- `telnetd` (tcp, lan): auth=unknown, risk=high; source=`_RAX54Sv2-V1.1.6.38.zip.extracted/364553`; evidence=service marker present
...
Structured zero-day triage JSON: `known_firmware/reports/RAX54SV2/RAX54Sv2-V1.1.6.38.zip.zero-day.json`

## Extraction Notes

- binwalk -eM --directory known_firmware/extracted/c9b1ed79f8f766b5 stopped: extraction exceeded 768 MB

## Decompiler Notes

- /home/jordan/Tools/ghidra_12.1.2_PUBLIC/support/analyzeHeadless known_firmware/ghidra_projects RAX54SV2_c9b1ed79 -import exited 0: OpenJDK 64-Bit Server VM (build 21.0.11+10-1-22.04.2-Ubuntu, mixed mode)
