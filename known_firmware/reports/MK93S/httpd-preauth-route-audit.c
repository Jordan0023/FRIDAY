...
===== FUNCTION FUN_0004b124 @ 0004b124 =====

void FUN_0004b124(char *param_1)

{
  ...
  iVar3 = *DAT_0004b1d8;
  pcVar1 = strstr(param_1,DAT_0004b1dc);
  if ((((pcVar1 == (char *)0x0) && (pcVar1 = strstr(param_1,DAT_0004b1e0), pcVar1 == (char *)0x0))
      && (pcVar1 = strstr(param_1,DAT_0004b1e4), pcVar1 == (char *)0x0)) &&
     ((pcVar1 = strstr(param_1,DAT_0004b1e8), pcVar1 == (char *)0x0 &&
      (pcVar1 = strstr(param_1,DAT_0004b1ec), pcVar1 == (char *)0x0)))) {
    pcVar1 = strstr(param_1,DAT_0004b1f0);
    uVar2 = 0;
    if (pcVar1 != (char *)0x0) {
      uVar2 = 1;
    }
...
===== FUNCTION FUN_00050944 @ 00050944 =====

void FUN_00050944(char *param_1,char *param_2,uint param_3,void *param_4)

{
  ...
  local_24 = *DAT_00050b04;
  local_1824[0] = '\0';
  local_1824[1] = '\0';
  local_1824[2] = '\0';
  local_1824[3] = '\0';
  memset(local_1824 + 4,0,0x7fc);
  local_1024[0] = 0;
  local_1024[1] = 0;
  local_1024[2] = 0;
  local_1024[3] = 0;
  ...
  if (param_4 == (void *)0x0) {
    strlcpy(param_2,DAT_00050b08,param_3);
  }
  else {
    iVar3 = strcmp(param_1,DAT_00050b0c);
    iVar1 = DAT_00050b10;
    if (((iVar3 == 0) || (iVar3 = strcmp(param_1,DAT_00050b14), iVar3 == 0)) ||
       (iVar3 = strcmp(param_1,DAT_00050b18), iVar3 == 0)) {
      uVar7 = *(uint *)(iVar1 + 0x4b8);
      __src = DAT_00050b20;
    }
    else {
      uVar7 = *(uint *)(iVar1 + 0x4b4);
      __src = DAT_00050b1c;
    }
    memcpy(auStack_824,__src,0x200);
    memcpy(acStack_624,param_4,0x80);
    strlcpy(auStack_5a4,param_1,0x580);
    __format = DAT_00050b24;
    if (param_3 < 0x41) {
      uVar2 = 0xffffffff;
      goto LAB_000509c0;
    }
    ...
    SHA256(local_1824,(uVar7 & 0x1f) + 0x20 >> 1,local_1024);
    pbVar5 = local_1024;
    __s = param_2;
    do {
      pcVar6 = __s + 2;
      snprintf(__s,param_3,__format,(uint)*pbVar5);
      pbVar5 = pbVar5 + 1;
      __s = pcVar6;
    } while (pcVar6 != param_2 + 0x40);
  }
  uVar2 = 0;
LAB_000509c0:
  if (local_24 != *DAT_00050b04) {
                    /* WARNING: Subroutine does not return */
    __stack_chk_fail(uVar2);
  }
  return;
...
===== FUNCTION FUN_00052228 @ 00052228 =====

void FUN_00052228(char *param_1,char *param_2,undefined4 param_3,undefined4 param_4,char *param_5)

{
  ...
  local_2c = *DAT_000526fc;
  pcVar1 = strstr(param_1,DAT_00052700);
  if (pcVar1 != (char *)0x0) {
    FUN_000a1644(param_2,param_3,param_1,1);
  }
  pcVar2 = strchr(param_1,0x3f);
  pcVar1 = DAT_00052704;
  if (pcVar2 != (char *)0x0) {
    param_5 = pcVar2 + 1;
    *pcVar2 = '\0';
  }
  iVar3 = strcmp(param_1,pcVar1);
  if (((((((iVar3 == 0) || (iVar3 = strcmp(param_1,DAT_00052760), iVar3 == 0)) ||
         (iVar3 = strcmp(param_1,DAT_00052764), iVar3 == 0)) ||
        ((iVar3 = strcmp(param_1,DAT_00052768), iVar3 == 0 ||
         (iVar3 = strcmp(param_1,DAT_0005276c), iVar3 == 0)))) ||
       ((iVar3 = strcmp(param_1,DAT_00052770), iVar3 == 0 ||
        ((iVar3 = strcmp(param_1,DAT_00052774), iVar3 == 0 ||
         (iVar3 = strcmp(param_1,DAT_00052778), iVar3 == 0)))))) ||
      (iVar3 = strcmp(param_1,DAT_0005277c), iVar3 == 0)) ||
     (((iVar3 = strcmp(param_1,DAT_00052780), iVar3 == 0 ||
       (iVar3 = strncmp(param_1,DAT_00052784,0xc), iVar3 == 0)) ||
      (pcVar1 = strstr(param_1,DAT_00052788), pcVar1 != (char *)0x0)))) {
LAB_000522a8:
    pcVar1 = strstr(param_1,DAT_00052708);
    bVar7 = pcVar1 == (char *)0x0;
  }
  else {
    iVar3 = acosNvramConfig_match(DAT_00052790,DAT_0005278c);
    bVar7 = false;
    if (iVar3 != 0) {
      pcVar1 = strstr(param_1,DAT_00052794);
      if ((((pcVar1 != (char *)0x0) ||
           (pcVar1 = strstr(param_1,DAT_00052798), pcVar1 != (char *)0x0)) ||
          ((pcVar1 = strstr(param_1,DAT_0005279c), pcVar1 != (char *)0x0 ||
           ((pcVar1 = strstr(param_1,DAT_000527a0), pcVar1 != (char *)0x0 ||
            (pcVar1 = strstr(param_1,DAT_000527a4), pcVar1 != (char *)0x0)))))) ||
         ((pcVar1 = strstr(param_1,DAT_000527a8), pcVar1 != (char *)0x0 ||
          (iVar3 = strcmp(param_1,DAT_000527ac), iVar3 == 0)))) goto LAB_000522a8;
      bVar7 = false;
    }
  }
  iVar4 = strcmp(param_1,DAT_0005270c);
  iVar3 = 0;
  if (iVar4 != 0) {
    iVar4 = strcmp(param_1,DAT_00052710);
    iVar3 = 0;
    if (iVar4 != 0) {
      iVar4 = strcmp(param_1,DAT_00052714);
      iVar3 = 0;
      if (iVar4 != 0) {
        iVar4 = strcmp(param_1,DAT_00052718);
        iVar3 = 0;
        if (iVar4 != 0) {
          iVar4 = strcmp(param_1,DAT_0005271c);
          iVar3 = 0;
          if (iVar4 != 0) {
            iVar4 = strcmp(param_1,DAT_00052720);
            iVar3 = 0;
            if (iVar4 != 0) {
              iVar4 = strcmp(param_1,DAT_00052724);
              iVar3 = 0;
              if (iVar4 != 0) {
                iVar4 = strcmp(param_1,DAT_00052728);
                iVar3 = 0;
                if (iVar4 != 0) {
                  iVar4 = strcmp(param_1,DAT_0005272c);
                  iVar3 = 0;
                  if (iVar4 != 0) {
                    iVar4 = strcmp(param_1,DAT_00052730);
                    iVar3 = 0;
                    if (iVar4 != 0) {
                      iVar4 = strcmp(param_1,DAT_00052734);
                      iVar3 = 0;
                      if (iVar4 != 0) {
                        pcVar1 = strstr(param_1,DAT_00052738);
                        if (pcVar1 == (char *)0x0) {
                          pcVar1 = strstr(param_1,DAT_0005273c);
                          iVar3 = 0;
                          if (pcVar1 != (char *)0x0) goto LAB_00052454;
                          if (*DAT_00052740 != 1) {
                            iVar4 = strcmp(param_1,DAT_00052744);
                            iVar3 = 0;
                            if (iVar4 != 0) {
                              iVar4 = strcmp(param_1,DAT_00052748);
                              iVar3 = 0;
                              if (iVar4 != 0) {
                                iVar4 = strcmp(param_1,DAT_0005274c);
                                iVar3 = 0;
                                if (iVar4 != 0) {
                                  iVar4 = strcmp(param_1,DAT_00052750);
                                  iVar3 = 0;
                                  if (iVar4 != 0) {
                                    iVar3 = strcmp(param_1,DAT_00052754);
                                    if (iVar3 == 0) {
                                      bVar7 = true;
                                    }
                                    if (bVar7) {
                                      ...
                                      iVar3 = FUN_00050b28(param_1,param_5);
                                    }
                                  }
                                }
                              }
...
LAB_00052454:
  ...
  iVar8 = 0;
  do {
    pcVar1 = *(char **)(DAT_00052758 + iVar8 * 8);
    if (pcVar1 == (char *)0x0) {
      bVar7 = false;
LAB_00052474:
      if (*DAT_0005275c == 0) {
      ...
      if (bVar7) {
        if (iVar3 == 0) {
          iVar3 = strcmp(param_1,DAT_0005272c);
          if (iVar3 != 0) {
            param_5 = param_2;
          }
          (**(code **)(iVar4 + iVar8 * 8 + 4))(param_5,param_3);
        }
        else {
          FUN_000520ec(DAT_000527b0,param_3);
          FUN_0005082c();
        }
      }
      else {
        pcVar1 = strstr(param_1,DAT_000527b4);
        if ((pcVar1 == (char *)0x0) &&
           (pcVar1 = strstr(param_1,DAT_000527b8), pcVar1 == (char *)0x0)) {
          FUN_00051ea4(0x194,acStack_42c,0);
          sVar6 = strlen(acStack_42c);
          FUN_000f8dc8(param_3,acStack_42c,sVar6);
        }
      }
      if (local_2c != *DAT_000526fc) {
                    /* WARNING: Subroutine does not return */
        __stack_chk_fail();
      }
      return;
    }
    iVar5 = strcmp(pcVar1,param_1);
    if (iVar5 == 0) {
      bVar7 = true;
      goto LAB_00052474;
    }
...
===== FUNCTION FUN_00051ea4 @ 00051ea4 =====

void FUN_00051ea4(int param_1,char *param_2,undefined4 param_3)

{
  ...
  local_24 = *DAT_000520b8;
  local_824 = 0;
  memset(auStack_820,0,0x7fc);
  if (param_1 == 0x194) {
    pcVar7 = *(char **)(DAT_000520c4 + 100);
    uVar4 = FUN_000e810c(DAT_000520e4);
    uVar5 = FUN_000e810c(DAT_000520e4);
    uVar8 = DAT_000520e8;
LAB_00051f80:
    uVar8 = FUN_000e810c(uVar8);
    sprintf(param_2,pcVar7,uVar4,uVar5,uVar8);
  }
  else {
    if (param_1 < 0x195) {
      if (param_1 == 400) {
        pcVar7 = *(char **)(DAT_000520c4 + 0x58);
        uVar4 = FUN_000e810c(DAT_000520cc);
        uVar5 = FUN_000e810c(DAT_000520cc);
        uVar8 = DAT_000520d0;
        goto LAB_00051f80;
      }
      if (param_1 != 0x191) goto LAB_00051f00;
      shared_br_device_detect_do_lan_scan();
      iVar3 = acosNvramConfig_match(DAT_000520d8,DAT_000520d4);
      puVar2 = DAT_000520c8;
      iVar1 = DAT_000520c4;
      if (iVar3 == 0) {
        uVar6 = *DAT_000520c8;
        pcVar7 = *(char **)(DAT_000520c4 + 0x60);
        uVar8 = FUN_000e810c(DAT_000520dc);
        uVar4 = FUN_000e810c(DAT_000520dc);
        uVar5 = FUN_000e810c(DAT_000520e0);
        sprintf(param_2,pcVar7,param_3,uVar6,uVar8,uVar4,uVar5);
        goto LAB_00051f00;
      }
      FUN_00050944(DAT_000520c0,&local_824,0x800,DAT_000520bc);
      pcVar7 = *(char **)(iVar1 + 0x5c);
      uVar8 = *puVar2;
    }
    else {
      if (param_1 == 0xbcd) {
        sprintf(param_2,*(char **)(DAT_000520c4 + 0x68),param_3);
        goto LAB_00051f00;
      }
      if (param_1 != 0xfab) goto LAB_00051f00;
      FUN_00050944(DAT_000520c0,&local_824,0x800,DAT_000520bc);
      pcVar7 = *(char **)(DAT_000520c4 + 0x5c);
      uVar8 = *DAT_000520c8;
    }
    uVar4 = FUN_000e810c(DAT_000520dc);
    uVar5 = FUN_000e810c(DAT_000520dc);
    uVar6 = FUN_000e810c(DAT_000520e0);
    sprintf(param_2,pcVar7,param_3,uVar8,uVar4,uVar5,uVar6,&local_824);
  }
LAB_00051f00:
  if (local_24 != *DAT_000520b8) {
                    /* WARNING: Subroutine does not return */
    __stack_chk_fail();
  }
  return;
...
===== TARGET passwordrecovered.cgi =====

===== TARGET secure_password.cgi =====

===== TARGET currentsetting.htm =====

===== FUNCTION FUN_000ae02c @ 000ae02c =====

void FUN_000ae02c(char *param_1)

{
  ...
  iVar4 = *DAT_000ae1b8;
  if ((((((undefined1 *)*DAT_000ae1bc != &DAT_000033e0) || (*DAT_000ae1c0 != 0x33f0)) &&
       (iVar2 = strcasecmp(param_1,DAT_000ae1c4), iVar2 != 0)) &&
      ((((iVar2 = strcasecmp(param_1,DAT_000ae1c8), iVar2 != 0 &&
         (iVar2 = strcasecmp(param_1,DAT_000ae1cc), iVar2 != 0)) &&
        ((iVar2 = strcasecmp(param_1,DAT_000ae1d0), iVar2 != 0 &&
         ((iVar2 = strcasecmp(param_1,DAT_000ae1d4), iVar2 != 0 &&
          (iVar2 = strcasecmp(param_1,DAT_000ae1d8), iVar2 != 0)))))) &&
       (iVar2 = strcasecmp(param_1,DAT_000ae1dc), iVar2 != 0)))) &&
     ((((iVar2 = strcasecmp(param_1,DAT_000ae1e0), iVar2 != 0 &&
        (iVar2 = strcasecmp(param_1,DAT_000ae1e4), iVar2 != 0)) &&
       (iVar2 = strcasecmp(param_1,DAT_000ae1e8), iVar2 != 0)) &&
      ((iVar2 = strcasecmp(param_1,DAT_000ae1ec), iVar2 != 0 &&
       (iVar3 = strcasecmp(param_1,DAT_000ae1f0), iVar2 = DAT_000ae1f4, iVar3 != 0)))))) {
    if (*(int *)(DAT_000ae1f4 + 0x804) == 1) {
      FUN_000ad91c();
    }
    else {
      FUN_000adf24();
...
===== FUNCTION FUN_000f9800 @ 000f9800 =====

void FUN_000f9800(int *param_1)

{
  ...
  SSL *local_2468;
  int local_2464;
  char acStack_2460 [20];
  int local_244c;
  int iStack_2448;
  int iStack_2444;
  int iStack_2440;
  in_addr_t local_243c;
  int iStack_2438;
  int iStack_2434;
  int iStack_2430;
  int local_242c;
  undefined1 auStack_2428 [256];
  undefined1 auStack_2328 [256];
  char acStack_2228 [512];
  undefined1 auStack_2028 [8196];
  
  local_244c = param_1[4];
  iStack_2448 = param_1[5];
  iStack_2444 = param_1[6];
  iStack_2440 = param_1[7];
  local_2470 = *param_1;
  local_243c = param_1[8];
  iStack_2438 = param_1[9];
  iStack_2434 = param_1[10];
  iStack_2430 = param_1[0xb];
  local_2478 = 5;
  local_242c = param_1[0xc];
  local_2464 = param_1[2];
  local_246c = param_1[3];
  local_2468 = (SSL *)0x0;
  local_2474 = 0;
  iVar16 = param_1[1];
  setsockopt(local_2470,1,0x14,&local_2478,8);
  iVar17 = DAT_000fa5d8 + 0xf98b8;
  setsockopt(local_2470,1,0x15,&local_2478,8);
  pVar2 = pthread_self();
  if ((iVar16 == 0) || (iVar16 = FUN_000f97ac(local_2470,local_2464,&local_2468), iVar16 != 0)) {
    __s = malloc(0x10000);
    shared_debug_log_do_write_log
              (DAT_000fa5e0 + 0xf9920,DAT_000fa5e8 + 0xf992c,DAT_000fa5e4 + 0xf9928,
               DAT_000fa5dc + 0xf9928,0x2ce,local_2470,pVar2);
    if (__s != (char *)0x0) {
      __s_00 = (char *)0x0;
      local_24ac = 0;
      local_24b4 = 0;
      iVar10 = DAT_000fa5ec + 0xf9964;
      iVar9 = DAT_000fa5f0 + 0xf9970;
      local_24bc = 0;
      local_24b8 = 0;
      iVar11 = DAT_000fa5f4 + 0xf9980;
      iVar12 = DAT_000fa5f8 + 0xf998c;
      sVar4 = 0;
      iVar16 = local_24b8;
LAB_000f999c:
      do {
        ...
        sVar3 = FUN_000f8d88(&local_2470,auStack_2028,0x2000);
        if ((int)sVar3 < 1) goto code_r0x000f99c4;
        __n = sVar4 + sVar3;
        iVar16 = local_24b8;
        if ((int)__n < 0x10000) {
          memcpy(__s + sVar4,auStack_2028,sVar3);
          __s[__n] = '\0';
          sVar4 = __n;
          if ((local_24b8 != 0) || (local_24b8 = FUN_000f906c(__s), local_24b8 != 0)) {
            iVar7 = local_24bc;
            iVar16 = local_24b8;
            if (local_24bc == 0) {
              iVar7 = FUN_000f9430(__s,__n,&local_2484,auStack_2428,&local_2480,auStack_2328);
              if (iVar7 == 5) {
                __s_00 = malloc(0x10000);
                if (__s_00 != (char *)0x0) {
                  memcpy(__s_00,__s,0x10000);
                }
                __n = __n - local_2480;
                pcVar13 = (char *)(DAT_000fa658 + 0xf9f18);
                memcpy(__s,__s + local_2480,__n);
                snprintf(acStack_2228,0x200,(char *)(DAT_000fa65c + 0xf9f44));
                shared_util_system(acStack_2228);
                mkdir(pcVar13,0x1fd);
                FUN_000f8ef4(auStack_2428);
LAB_000f9f64:
                iVar7 = FUN_000f9238(__s,__n,auStack_2428,local_2484);
                local_24ac = iVar7 + 0xffff;
                if (-1 < iVar7) {
                  local_24ac = iVar7;
                }
                local_24ac = local_24ac >> 0x10;
                if (local_24bc != local_24ac) {
                  fputc(0x2e,(FILE *)**(undefined4 **)(iVar17 + DAT_000fa618));
                }
                if (iVar7 < local_2484) {
                  local_24bc = 5;
                  sVar4 = 0;
                  ...
                  acosNvramConfig_set(iVar11,auStack_2428);
                  iVar8 = DAT_000fa660 + 0xfa004;
                  iVar7 = DAT_000fa664 + 0xfa00c;
                  local_24bc = 5;
                  shared_debug_log_do_write_log(iVar7,iVar8,iVar12,iVar9,0x338,local_2470,pVar2);
                  sVar4 = strlen(__s_00);
                  shared_debug_log_write_log(iVar7,iVar8,iVar9,0x339,__s_00,sVar4);
                  FUN_0004b3c0(__s_00,__s_00,&local_244c,&local_2470);
                  sVar4 = 0;
                }
                goto LAB_000f999c;
              }
              if (iVar7 != 6) goto LAB_000f9a70;
              __n = __n - local_2480;
              pcVar13 = (char *)(DAT_000fa610 + 0xf9b78);
              memcpy(__s,__s + local_2480,__n);
              snprintf(acStack_2228,0x200,(char *)(DAT_000fa614 + 0xf9ba4));
              shared_util_system(acStack_2228);
              mkdir(pcVar13,0x1fd);
              FUN_000f8ef4(auStack_2428);
            }
...
LAB_000f9a70:
              ...
              if (local_24bc == 1) {
                if (local_24b4 == 0) {
                  local_24b4 = local_24bc;
                  FUN_0006c1f8(&local_2470);
                }
                else {
                  local_24bc = local_24b4;
                }
                goto LAB_000f999c;
              }
              if (local_24bc == 2) {
                if (local_24b4 == 0) {
                  local_24b4 = 1;
                  FUN_0005c524(&local_2470);
                }
                goto LAB_000f999c;
              }
              if (local_24bc == 4) {
                if (local_24b4 == 0) {
                  FUN_000520ec(DAT_000fa60c + 0xf9ab0,&local_2470);
                  local_24b4 = 1;
                  FUN_0005082c();
                }
                goto LAB_000f999c;
              ...
              if (local_24bc == 5) {
                local_24bc = local_24ac;
                goto LAB_000f9f64;
              }
              if (local_24bc != 6) goto LAB_000f999c;
              local_24bc = local_24ac;
            }
            local_2498 = auStack_2328;
            local_24ac = FUN_000f92b8(__s,__n,auStack_2428,0x40000,local_2498);
            if (local_24ac == 0) {
              iVar7 = FUN_0005c9a4(auStack_2428,&local_2470,local_24b4);
              local_24ac = local_24bc;
              if (iVar7 != 0) {
                local_24b4 = 1;
                local_24bc = 6;
                sVar4 = 0;
              ...
              if (local_24ac != -1) {
                if (local_24ac < 0) {
                  local_24ac = local_24ac + 0x7ff;
                }
                local_24ac = local_24ac >> 0xb;
                if (local_24bc == local_24ac) {
                  local_24bc = 6;
                  sVar4 = 0;
                }
          ...
          if (local_246c == 1) {
            iVar7 = DAT_000fa61c + 0xf9c90;
            iVar16 = acosNvramConfig_match(DAT_000fa620 + 0xf9c94,iVar7);
            if (iVar16 == 0) goto LAB_000f9ae0;
            iVar16 = FUN_0004b024(__s,local_247c);
            if (iVar16 == 0) goto LAB_000f999c;
            iVar16 = FUN_00049754(__s);
            if (iVar16 == 0) {
              iVar16 = strncmp(__s,(char *)(DAT_000fa624 + 0xf9ce4),0x17);
              if (iVar16 == 0) {
                FUN_000520ec(DAT_000fa694 + 0xfa1ec,&local_2470);
                iVar16 = 0;
                goto LAB_000f999c;
              }
              iVar16 = strncmp(__s,(char *)(DAT_000fa628 + 0xf9d04),0x19);
              if (iVar16 == 0) {
                FUN_000520ec(DAT_000fa6b0 + 0xfa2e0,&local_2470);
                iVar16 = 0;
              }
              else {
                iVar16 = strncmp(__s,(char *)(DAT_000fa62c + 0xf9d24),0xe);
                if (iVar16 != 0) {
                  iVar16 = FUN_000f8c50(__s);
                  if ((iVar16 != 0) || (iVar16 = FUN_000f8cc4(__s), iVar6 = local_243c, iVar16 != 0)
                     ) {
                    iVar7 = DAT_000fa6b8 + 0xfa308;
                    iVar16 = DAT_000fa6b4 + 0xfa314;
                    local_2498 = (undefined1 *)(DAT_000fa6bc + 0xfa314);
                    local_24b8 = 0;
                    shared_debug_log_do_write_log
                              (iVar7,local_2498,DAT_000fa6c0 + 0xfa324,iVar16,0x3be,local_2470,pVar2
                              );
                    sVar4 = strlen(__s);
                    uVar14 = 0x3bf;
                    goto LAB_000f9eb0;
                  }
                  local_24b8 = local_244c;
                  if (local_244c == 0) {
                    iVar5 = inet_addr((char *)(DAT_000fa6e0 + 0xfa494));
                    iVar1 = local_243c;
                    if (iVar6 == iVar5) {
                      iVar7 = DAT_000fa708 + 0xfa594;
                      iVar16 = DAT_000fa704 + 0xfa5a0;
                      local_2498 = (undefined1 *)(DAT_000fa70c + 0xfa5a0);
                      shared_debug_log_do_write_log
                                (iVar7,local_2498,DAT_000fa710 + 0xfa5a8,iVar16,0x3cd,local_2470,
                                 pVar2);
                      sVar4 = strlen(__s);
                      uVar14 = 0x3ce;
                      goto LAB_000f9eb0;
                    ...
                    local_24b8 = local_244c;
                    if (local_244c == 0) {
                      pcVar13 = (char *)acosNvramConfig_get(DAT_000fa6e4 + 0xfa4bc);
                      iVar6 = inet_addr(pcVar13);
                      if (iVar1 == iVar6) {
                        iVar7 = DAT_000fa6ec + 0xfa4f0;
                        iVar16 = DAT_000fa6e8 + 0xfa4fc;
                        local_2498 = (undefined1 *)(DAT_000fa6f0 + 0xfa4fc);
                        shared_debug_log_do_write_log
                                  (iVar7,local_2498,DAT_000fa6f4 + 0xfa504,iVar16,0x3da,local_2470,
                                   pVar2);
                        sVar4 = strlen(__s);
                        uVar14 = 0x3db;
                        goto LAB_000f9eb0;
                  ...
                  if (local_244c == 1) {
                    inet_pton(10,(char *)(DAT_000fa6dc + 0xfa440),acStack_2460);
                    iVar16 = memcmp(&iStack_2438,acStack_2460,0x10);
                    if (iVar16 == 0) goto LAB_000f999c;
                  }
                  pcVar13 = strcasestr(__s,(char *)(DAT_000fa698 + 0xfa26c));
                  __isoc99_sscanf(pcVar13,DAT_000fa69c + 0xfa280,acStack_2460);
                  pcVar13 = strcasestr(acStack_2460,(char *)(DAT_000fa6a0 + 0xfa294));
                  if (pcVar13 == (char *)0x0) {
                    acosNvramConfig_set(DAT_000fa6d8 + 0xfa41c,acStack_2460);
                  }
                  else {
                    acosNvramConfig_set(DAT_000fa6a8 + 0xfa2b4,DAT_000fa6a4 + 0xfa2b0);
                  }
                  FUN_000520ec(DAT_000fa6ac + 0xfa2c4,&local_2470);
                  local_24b8 = 0;
                  iVar16 = local_24b8;
                  goto LAB_000f999c;
                }
                FUN_000520ec(DAT_000fa630 + 0xf9d40,&local_2470);
                iVar16 = 0;
              }
              goto LAB_000f999c;
            }
            iVar8 = DAT_000fa67c + 0xfa150;
            iVar15 = DAT_000fa678 + 0xfa15c;
            iVar16 = DAT_000fa680 + 0xfa15c;
            shared_debug_log_do_write_log
                      (iVar16,iVar8,DAT_000fa684 + 0xfa164,iVar15,0x392,local_2470,pVar2);
            sVar3 = strlen(__s);
            shared_debug_log_write_log(iVar16,iVar8,iVar15,0x393,__s,sVar3);
            iVar16 = acosNvramConfig_match(DAT_000fa688 + 0xfa1a4,iVar7);
            iVar6 = local_243c;
            if (iVar16 != 0) {
              sVar3 = strlen(__s);
              FUN_00073748(__s,&local_2470,local_243c,sVar3,&local_244c,1);
              iVar16 = local_24b8;
              goto LAB_000f999c;
            }
            if (local_244c != 0) {
LAB_000fa1bc:
              printf((char *)(DAT_000fa690 + 0xfa1d8),DAT_000fa68c + 0xfa1f4,0x3a4);
              iVar16 = 0;
              goto LAB_000f999c;
            }
            iVar5 = inet_addr((char *)(DAT_000fa6c4 + 0xfa36c));
            iVar1 = local_243c;
            local_24b8 = local_244c;
            if (iVar6 != iVar5) {
              if (local_244c == 0) {
                pcVar13 = (char *)acosNvramConfig_get(DAT_000fa6c8 + 0xfa390);
                iVar6 = inet_addr(pcVar13);
                if (iVar1 == iVar6) {
                  puts((char *)(DAT_000fa6cc + 0xfa3b4));
                  printf((char *)(DAT_000fa6d4 + 0xfa3cc),DAT_000fa6d0 + 0xfa3ec,0x39f);
                  goto LAB_000f9df4;
                }
              }
              goto LAB_000fa1bc;
            ...
            local_24b8 = 0;
            puts((char *)(DAT_000fa6f8 + 0xfa548));
            printf((char *)(DAT_000fa700 + 0xfa560),DAT_000fa6fc + 0xfa580,0x399);
          }
          else {
LAB_000f9ae0:
            iVar16 = FUN_0004b024(__s,local_247c);
            ...
            iVar16 = FUN_00049754(__s);
            if (iVar16 == 0) {
              iVar7 = DAT_000fa64c + 0xf9e70;
              local_2498 = (undefined1 *)(DAT_000fa650 + 0xf9e74);
              shared_debug_log_do_write_log
                        (iVar7,local_2498,DAT_000fa654 + 0xf9e84,iVar10,0x424,local_2470,pVar2);
              sVar4 = strlen(__s);
              uVar14 = 0x425;
              __n = 0;
              local_24b8 = 0;
              iVar16 = iVar10;
LAB_000f9eb0:
              shared_debug_log_write_log(iVar7,local_2498,iVar16,uVar14,__s,sVar4);
              FUN_0004b3c0(__s,0,&local_244c,&local_2470);
              sVar4 = __n;
              iVar16 = local_24b8;
              goto LAB_000f999c;
            }
            iVar7 = DAT_000fa634 + 0xf9d88;
            iVar8 = DAT_000fa638 + 0xf9d80;
            iVar16 = DAT_000fa63c + 0xf9d88;
            shared_debug_log_do_write_log
                      (iVar8,iVar16,DAT_000fa640 + 0xf9d90,iVar7,0x411,local_2470,pVar2);
            sVar4 = strlen(__s);
            shared_debug_log_write_log(iVar8,iVar16,iVar7,0x412,__s,sVar4);
            iVar16 = acosNvramConfig_match(DAT_000fa648 + 0xf9dd0,DAT_000fa644 + 0xf9dcc);
            iVar6 = local_243c;
            if ((iVar16 == 0) && (1 < local_246c - 2U)) {
              if (local_244c != 0) {
LAB_000fa094:
                local_24b8 = 0;
                printf((char *)(DAT_000fa674 + 0xfa0b8),DAT_000fa670 + 0xfa0d4,0x418);
                sVar4 = 0;
                iVar16 = local_24b8;
                goto LAB_000f999c;
              }
              iVar5 = inet_addr((char *)(DAT_000fa668 + 0xfa070));
              iVar1 = local_243c;
              if (iVar6 != iVar5) {
                pcVar13 = (char *)acosNvramConfig_get(DAT_000fa66c + 0xfa088);
                iVar6 = inet_addr(pcVar13);
                if (iVar1 != iVar6) goto LAB_000fa094;
              }
            }
            __n = 0;
            local_24b8 = 0;
...
LAB_000f9df4:
          sVar4 = strlen(__s);
          FUN_00073748(__s,&local_2470,local_243c,sVar4,&local_244c,1);
          sVar4 = __n;
          iVar16 = local_24b8;
        }
      } while( true );
...
LAB_000f99dc:
  shared_debug_log_do_write_log
            (DAT_000fa600 + 0xf9a04,DAT_000fa608 + 0xf9a14,DAT_000fa604 + 0xf9a10,
             DAT_000fa5fc + 0xf9a10,0x43b,local_2470,pVar2);
  if (local_2470 != 0) {
    shutdown(local_2470,2);
    close(local_2470);
  }
  if (local_2468 != (SSL *)0x0) {
    SSL_free(local_2468);
  }
  free(param_1);
                    /* WARNING: Subroutine does not return */
...
===== FUNCTION FUN_000770a8 @ 000770a8 =====

undefined4 FUN_000770a8(undefined4 param_1,char *param_2,char *param_3)

{
  ...
  local_1c = *DAT_00077220;
  local_11c[0] = 0;
  local_11c[1] = 0;
  local_11c[2] = 0;
  local_11c[3] = 0;
  memset(local_11c + 4,0,0xfc);
  iVar1 = FUN_00076c08(param_1,DAT_00077224,local_11c,0xff);
  if (-1 < iVar1) {
    local_1d = 0;
    sVar2 = strlen((char *)local_11c);
    pbVar3 = local_11c + sVar2;
    while (((sVar2 = sVar2 - 1, 0 < (int)sVar2 && (uVar6 = pbVar3[-1] - 9 & 0xff, uVar6 < 0x1a)) &&
           (pbVar3 = pbVar3 + -1, (~(DAT_0007722c >> uVar6) & 1) == 0))) {
      *pbVar3 = 0;
    }
    pbVar3 = local_11c;
    do {
      ...
      if (0x19 < uVar6) break;
      pbVar3 = pbVar5 + 1;
    } while ((~(DAT_0007722c >> uVar6) & 1) == 0);
    iVar1 = strnicmp(pbVar5,DAT_00077230,0x1b);
    if (iVar1 == 0) {
      pcVar4 = strstr((char *)(pbVar5 + 0x1b),DAT_00077238);
      if (pcVar4 != (char *)0x0) {
        *pcVar4 = '\0';
        if (param_2 != (char *)0x0) {
          strcpy(param_2,(char *)(pbVar5 + 0x1b));
        }
        uVar7 = 0;
        if (param_3 != (char *)0x0) {
          strcpy(param_3,pcVar4 + 3);
        }
        goto LAB_00077180;
      }
    }
...
===== FUNCTION FUN_00049754 @ 00049754 =====

undefined4 FUN_00049754(char *param_1,undefined4 param_2,undefined4 param_3)

{
  ...
  iVar5 = *DAT_000498e8;
  iVar1 = acosNvramConfig_match(DAT_000498f0,DAT_000498ec,param_3,0,param_1);
  if (iVar1 != 0) {
    uVar6 = 0;
    printf(DAT_000498f8,DAT_000498f4,0x4a2);
    goto LAB_00049794;
  }
  pcVar2 = strcasestr(param_1,DAT_000498fc);
  if ((pcVar2 == (char *)0x0) || (pcVar2 = strcasestr(param_1,DAT_00049900), pcVar2 == (char *)0x0))
  {
    uVar6 = 0;
    if (param_1 == (char *)0x0) goto LAB_00049794;
    pcVar3 = strcasestr(param_1,DAT_00049900);
    pcVar2 = DAT_00049910;
    if (pcVar3 == (char *)0x0) {
      pcVar2 = strcasestr(param_1,DAT_00049914);
      if (pcVar2 != (char *)0x0) {
        pcVar4 = strcasestr(pcVar2,DAT_00049918);
        pcVar3 = DAT_0004991c;
        if (pcVar4 != (char *)0x0) {
          *pcVar4 = '\0';
        }
        pcVar3 = strcasestr(pcVar2,pcVar3);
        if (pcVar4 != (char *)0x0) {
          *pcVar4 = '\r';
        }
        pcVar2 = DAT_00049920;
        if (pcVar3 != (char *)0x0) goto LAB_0004987c;
      }
      pcVar2 = strcasestr(param_1,DAT_00049924);
      if (pcVar2 == (char *)0x0) goto LAB_00049794;
      pcVar4 = strcasestr(pcVar2,DAT_00049918);
      pcVar3 = DAT_00049928;
      if (pcVar4 != (char *)0x0) {
        *pcVar4 = '\0';
      }
      pcVar2 = strstr(pcVar2,pcVar3);
      if (pcVar4 != (char *)0x0) {
        *pcVar4 = '\r';
      }
      if (pcVar2 == (char *)0x0) goto LAB_00049794;
      printf(DAT_0004992c,DAT_00049928);
    }
    else {
LAB_0004987c:
      puts(pcVar2);
    ...
    printf(DAT_00049904,DAT_000498f4,0x4a8);
    pcVar2 = (char *)acosNvramConfig_get(DAT_00049908);
    if (*pcVar2 != '\0') {
      pcVar2 = (char *)acosNvramConfig_get(DAT_00049908);
      iVar1 = atoi(pcVar2);
      *DAT_0004990c = iVar1;
