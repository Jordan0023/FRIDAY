...
===== TARGET 0004b124 =====
REF depth=0 from=0004cb38 to=0004b124
...
===== TARGET 00052228 =====
REF depth=0 from=0004ecf8 to=00052228
REF depth=0 from=00053188 to=00052228
...
===== FUNCTION FUN_000527bc @ 000527bc =====

void FUN_000527bc(char *param_1,int param_2,int param_3,int *param_4,undefined4 param_5)

{
  ...
  int iVar8;
  FILE *__stream_00;
  char acStack_90204 [52];
  char acStack_901d0 [80];
  char acStack_90180 [336];
  char acStack_90030 [65540];
  char acStack_8002c [524296];
  
  iVar8 = *DAT_000531cc;
  if ((param_2 == 0 || param_1 == (char *)0x0) ||
     (__ptr = malloc(DAT_000531d0), __ptr == (void *)0x0)) {
    if (iVar8 == *DAT_000531cc) {
      return;
    }
    goto LAB_00052bdc;
  }
  if (*param_1 == '\0') {
    strcpy(param_1,DAT_000531d4);
  }
  pcVar4 = param_1;
  snprintf(acStack_901d0,0x50,DAT_000531d8,DAT_000531dc,param_1);
  pcVar1 = (char *)acosNvramConfig_get(DAT_000531e0);
  iVar2 = strcmp(pcVar1,DAT_000531e4);
  pcVar1 = DAT_000531e8;
  if (iVar2 != 0) {
    pcVar1 = DAT_000531ec;
  }
  snprintf(acStack_90180,0x150,pcVar1,acStack_901d0,pcVar4);
  if (*param_1 == '\0') {
    iVar2 = acosNvramConfig_match(DAT_000531f0,DAT_000531e4);
    __stream_00 = (FILE *)0x0;
    if (iVar2 != 0) {
      printf(DAT_000531f8,DAT_000531f4,0x11e,acStack_90180);
      __stream_00 = (FILE *)0x0;
    }
  }
  else {
    iVar2 = acosNvramConfig_match(DAT_000531f0,DAT_000531e4);
    if (iVar2 != 0) {
      printf(DAT_000531f8,DAT_000531f4,0x124,acStack_90180);
    }
    __stream_00 = fopen(acStack_90180,DAT_0005321c);
  }
  iVar2 = acosNvramConfig_match(DAT_000531fc,DAT_000531e4);
  if (iVar2 != 0) {
    __stream = fopen(DAT_00053204,DAT_00053200);
    fprintf(__stream,DAT_00053208,acStack_901d0);
    fclose(__stream);
  }
  pcVar1 = strstr(param_1,DAT_0005320c);
  if (pcVar1 != (char *)0x0) {
    __stream_00 = (FILE *)0x0;
  }
  pcVar1 = (char *)acosNvramConfig_get(DAT_00053210);
  iVar2 = atoi(pcVar1);
  if (__stream_00 == (FILE *)0x0 && iVar2 == 1) {
    pcVar1 = strstr(acStack_901d0,DAT_00053214);
    if ((pcVar1 == (char *)0x0) ||
       (iVar2 = acosNvramConfig_match(DAT_00053218,DAT_000531e4), iVar2 == 0)) {
      pcVar1 = strstr(acStack_901d0,DAT_00053264);
      uVar3 = DAT_0005326c;
      if ((pcVar1 == (char *)0x0) &&
         ((pcVar1 = strstr(acStack_901d0,DAT_00053268), uVar3 = DAT_0005326c, pcVar1 == (char *)0x0
          && (*param_4 != 0)))) {
        pcVar1 = strstr(acStack_901d0,DAT_00053270);
        if (pcVar1 != (char *)0x0) {
          pcVar1 = strstr(acStack_901d0,DAT_00053274);
          __stream_00 = (FILE *)0x0;
          if (pcVar1 != (char *)0x0) goto LAB_00052944;
        }
        pcVar1 = (char *)acosNvramConfig_get(DAT_000531e0);
        iVar2 = strcmp(pcVar1,DAT_000531e4);
        uVar3 = DAT_00053278;
      ...
      strlcpy(acStack_901d0,uVar3,0x50);
    }
    __stream_00 = fopen(acStack_901d0,DAT_0005321c);
  }
LAB_00052944:
  pcVar1 = (char *)acosNvramConfig_get(DAT_00053210);
  iVar2 = atoi(pcVar1);
  if (((iVar2 == 1) && (iVar2 = strcmp(acStack_901d0,DAT_00053220), iVar2 == 0)) &&
     (iVar2 = acosNvramConfig_match(DAT_00053224,DAT_000531e4), iVar2 == 0)) {
    pcVar1 = (char *)acosNvramConfig_get(DAT_000531e0);
    iVar2 = strcmp(pcVar1,DAT_000531e4);
    uVar3 = DAT_00053228;
    if (iVar2 != 0) {
  ...
  pcVar1 = (char *)acosNvramConfig_get(DAT_00053210);
  iVar2 = atoi(pcVar1);
  if ((iVar2 == 1) && (iVar2 = strcmp(acStack_901d0,DAT_00053230), iVar2 == 0)) {
    pcVar1 = (char *)acosNvramConfig_get(DAT_00053234);
    iVar2 = atoi(pcVar1);
    if (iVar2 == 1) {
      ...
      strlcpy(acStack_901d0,uVar3,0x50);
      __stream_00 = fopen(acStack_901d0,DAT_0005321c);
      acosNvramConfig_set(DAT_00053234,DAT_00053240);
      acosNvramConfig_save();
    }
  }
  pcVar1 = (char *)acosNvramConfig_get(DAT_00053210);
  ...
  if (iVar2 == 0) {
    ...
    iVar2 = atoi(pcVar1);
    if (iVar2 == 1) {
      iVar2 = strcmp(acStack_901d0,DAT_00053244);
      if (((iVar2 == 0) || (iVar2 = strcmp(acStack_901d0,DAT_00053220), iVar2 == 0)) ||
         ((iVar2 = strcmp(acStack_901d0,DAT_000531d4), iVar2 == 0 ||
          ((pcVar1 = strstr(acStack_901d0,DAT_00053248), pcVar1 == (char *)0x0 ||
           (iVar2 = acosNvramConfig_match(DAT_0005324c,DAT_000531e4), iVar2 != 0)))))) {
        iVar2 = acosNvramConfig_match(DAT_0005324c,DAT_000531e4);
        if (iVar2 == 0) goto LAB_00052b30;
        acosNvramConfig_set(DAT_00053234,DAT_00053240);
        uVar3 = DAT_0005324c;
      }
      else {
      ...
      acosNvramConfig_set(uVar3,DAT_00053240);
      acosNvramConfig_save();
    }
  }
LAB_00052b30:
  pcVar1 = strstr(acStack_901d0,DAT_00053258);
  if (pcVar1 != (char *)0x0) {
    strlcpy(acStack_901d0,DAT_0005325c,0x50);
    __stream_00 = fopen(acStack_901d0,DAT_0005321c);
  }
  if (__stream_00 == (FILE *)0x0) {
    pcVar1 = strstr(acStack_901d0,DAT_00053270);
    if ((pcVar1 == (char *)0x0) ||
       (pcVar1 = strstr(acStack_901d0,DAT_00053274), pcVar1 == (char *)0x0 || param_3 == 0)) {
      iVar2 = strcmp(acStack_901d0,DAT_000532b4);
      if (iVar2 == 0) {
        FUN_0005ab8c(param_2);
      }
      else {
        iVar2 = strcmp(acStack_901d0,DAT_00053214);
        if (iVar2 == 0) {
          FUN_0005b0e8(param_2);
        }
        else {
          pcVar1 = strstr(param_1,DAT_0005320c);
          if (pcVar1 == (char *)0x0) {
            ...
            FUN_00052228(param_1,pcVar1,param_2,param_3,pcVar1);
          }
          else {
            iVar2 = acosNvramConfig_match(DAT_000531f0,DAT_000531e4);
            if (iVar2 != 0) {
              printf(DAT_000532a4,DAT_000531f4,0x2de,param_1);
            }
            snprintf(acStack_90030,DAT_000532bc,DAT_000532b8,param_1,param_5);
            pcVar1 = strstr(acStack_90030,DAT_000532c0);
            if (pcVar1 != (char *)0x0) {
              memset(acStack_8002c,0,DAT_000532bc);
              pcVar4 = DAT_000532c4;
              if (*pcVar1 != '/') {
                pcVar4 = DAT_000531ec;
              }
              snprintf(acStack_8002c,DAT_000532bc,pcVar4,pcVar1,param_5);
              pcVar1 = strchr(acStack_8002c,0x3f);
              if (pcVar1 != (char *)0x0) {
                *pcVar1 = '\0';
              }
              iVar2 = access(acStack_8002c,0);
              if (iVar2 == 0) {
                printf(DAT_000532cc,DAT_000532c8,0x2fb,acStack_90030);
                FUN_000a1644(DAT_000531dc,param_2,acStack_90030,0);
              }
            }
          }
        }
      ...
      FUN_0005bfac(param_2);
    }
  }
  else {
    uVar3 = FUN_00051ac4(acStack_901d0);
    pcVar1 = acStack_90204;
    strlcpy(pcVar1,uVar3,0x32);
    iVar2 = strcmp(acStack_901d0,DAT_00053260);
    if (iVar2 == 0) {
      FUN_00050fe0(acStack_901d0,__stream_00,__ptr);
      FUN_000519c0(param_2,__ptr,pcVar1);
    }
    else {
      iVar2 = strcmp(pcVar1,DAT_00053280);
      if (iVar2 == 0) {
        FUN_000ae02c(acStack_901d0);
        FUN_00050fe0(acStack_901d0,__stream_00,__ptr);
        pcVar4 = strstr(acStack_901d0,DAT_00053284);
        if (pcVar4 == (char *)0x0) {
LAB_00052d18:
          FUN_00051880(param_2,__ptr,pcVar1);
        }
      }
      else {
        iVar2 = strcmp(pcVar1,DAT_00053288);
        if (iVar2 == 0) {
          FUN_00050fe0(acStack_901d0,__stream_00,__ptr);
          FUN_00051784(param_2,__ptr);
        }
        else {
          iVar2 = strcmp(pcVar1,DAT_0005328c);
          if (iVar2 == 0) {
            FUN_00050fe0(acStack_901d0,__stream_00,__ptr);
            pcVar1 = DAT_00053290;
            goto LAB_00052d18;
          }
          uVar5 = FUN_00051b74(__stream_00,acStack_8002c);
          if (uVar5 < 0x80000) {
            pcVar1 = strstr(param_1,DAT_00053294);
            if ((pcVar1 == (char *)0x0) &&
               (pcVar1 = strstr(param_1,DAT_00053298), pcVar1 == (char *)0x0)) {
              uVar3 = FUN_00051ac4(acStack_901d0);
              snprintf(acStack_90030,400,DAT_0005329c,uVar5,uVar3);
              iVar2 = acosNvramConfig_match(DAT_000531f0,DAT_000531e4);
              if (iVar2 != 0) {
                uVar3 = 0x261;
LAB_00052e88:
                printf(DAT_000532a4,DAT_000531f4,uVar3,param_1);
              }
            }
            else {
              uVar3 = FUN_00051ac4(acStack_901d0);
              snprintf(acStack_90030,400,DAT_000532a0,uVar5,uVar3);
              iVar2 = acosNvramConfig_match(DAT_000531f0,DAT_000531e4);
              if (iVar2 != 0) {
                uVar3 = 0x26a;
                goto LAB_00052e88;
            ...
            sVar6 = strlen(acStack_90030);
            iVar2 = FUN_000f8dc8(param_2,acStack_90030,sVar6);
            if (uVar5 != 0 && iVar2 != -1) {
              FUN_000f8dc8(param_2,acStack_8002c,uVar5);
            }
          }
          else {
            ...
            iVar2 = acosNvramConfig_match(DAT_000531f0,DAT_000531e4);
            if (iVar2 != 0) {
              printf(DAT_000532a8,DAT_000531f4,0x284);
            }
            pcVar1 = strstr(param_1,DAT_00053294);
            if ((pcVar1 == (char *)0x0) &&
               (pcVar1 = strstr(param_1,DAT_00053298), pcVar1 == (char *)0x0)) {
              uVar3 = FUN_00051ac4(acStack_901d0);
              snprintf(acStack_90030,400,DAT_000532ac,lVar7,uVar3);
              iVar2 = acosNvramConfig_match(DAT_000531f0,DAT_000531e4);
              if (iVar2 != 0) {
                printf(DAT_000532a4,DAT_000531f4,0x290,param_1);
              }
            }
            else {
              uVar3 = FUN_00051ac4(acStack_901d0);
              snprintf(acStack_90030,400,DAT_000532b0,lVar7,uVar3);
            }
            sVar6 = strlen(acStack_90030);
            iVar2 = FUN_000f8dc8(param_2,acStack_90030,sVar6);
            if (lVar7 != 0 && iVar2 != -1) {
              fseek(__stream_00,0,0);
              while (sVar6 = fread(acStack_8002c,1,0x80000,__stream_00), 0 < (int)sVar6) {
                FUN_000f8dc8(param_2,acStack_8002c);
              }
            }
          }
          fclose(__stream_00);
