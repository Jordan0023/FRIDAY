...
- Parameters: 2g_radio_hint, 2g_title, 5g_2_radio_hint, 5g_2_title, 5g_radio_hint, 5g_title, ACL_disabled_hint, ACL_enabled_hint, ClientList_Block_PC, DNSsetting, Dev3G, ExtOption
...
- Score: 18
- Evidence level: L2
- Source: string:www/Advanced_Modem_Content.asp
- Parameters: ClientList_Block_PC, DNS1, DNS2, Dev3G, Epage_Suggest, Epage_Suggest1, Epage_Suggest2, FormTitle, LanProto, Loading, LoadingBar, RemoteAP
- Matched risk keywords: wan
- Next checks: map route to handler and auth gate; trace each risky parameter into command/file/memory sinks; prove or reject parameter-to-system/popen/exec flow
...
Structured zero-day triage JSON: `known_firmware/reports/ASUS_RT-N10U_B/FW_RT_N10U_B1_30043763754.zip.zero-day.json`

## Extraction Notes

- Using existing extraction directory: known_firmware/extracted/c11201c86d8af373
