...
- Parameters: Dev3G, Loading, LoadingBar, QKform, action_mode, action_script, action_wait, alertImg, apn_bar_container, apn_div, apn_proceeding_img, apn_proceeding_img_text
...
- `ATE: [BWLIT][%s(%d)]: Create iptables rules done.`
...
Structured zero-day triage JSON: `known_firmware/reports/ASUS_RT-N10P_V3/FW_RT_N10P_V3_30043805810.zip.zero-day.json`

## Extraction Notes

- Using existing extraction directory: known_firmware/extracted/e6add48ce717ee40
