...
- `files/GDC/EAX15v3/EAX15v3_firmware_V1.0.3.38.zip`: rejected: route is not correlated with a dangerous sink; auth=unknown; evidence=L0; score=2
...
Structured zero-day triage JSON: `known_firmware/reports/EAX15V3/EAX15v3_firmware_V1.0.3.38.zip.zero-day.json`

## Extraction Notes

- Using existing extraction directory: known_firmware/extracted/ed9130b0bf364602
