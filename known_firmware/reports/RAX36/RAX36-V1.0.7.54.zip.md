...
- `telnetd` (tcp, lan): auth=unknown, risk=high; source=`_RAX36-V1.0.7.54.zip.extracted/65DAAB`; evidence=service marker present
- `ftpd` (tcp, lan): auth=unknown, risk=medium; source=`_RAX36-V1.0.7.54.zip.extracted/65DAAB`; evidence=service marker present
...
Structured zero-day triage JSON: `known_firmware/reports/RAX36/RAX36-V1.0.7.54.zip.zero-day.json`

## Extraction Notes

- binwalk -eM --directory known_firmware/extracted/7dfad4f35401482f stopped: extraction exceeded 768 MB

## Decompiler Notes

- /home/jordan/Tools/ghidra_12.1.2_PUBLIC/support/analyzeHeadless known_firmware/ghidra_projects RAX36_7dfad4f3 -import exited 0: OpenJDK 64-Bit Server VM (build 21.0.11+10-1-22.04.2-Ubuntu, mixed mode)
- /home/jordan/Tools/ghidra_12.1.2_PUBLIC/support/analyzeHeadless known_firmware/ghidra_projects RAX36_7dfad4f3 -import exited 0: OpenJDK 64-Bit Server VM (build 21.0.11+10-1-22.04.2-Ubuntu, mixed mode)
- /home/jordan/Tools/ghidra_12.1.2_PUBLIC/support/analyzeHeadless known_firmware/ghidra_projects RAX36_7dfad4f3 -import exited 0: OpenJDK 64-Bit Server VM (build 21.0.11+10-1-22.04.2-Ubuntu, mixed mode)
