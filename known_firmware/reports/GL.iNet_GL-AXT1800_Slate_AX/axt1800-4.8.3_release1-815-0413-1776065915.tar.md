...
- `class/net/ovpnclient/queues/rx-0/rps_cpus`: deprioritized: sink exists but no attacker-controlled parameter is identified; auth=unknown; evidence=L2; score=16
- `class/net/ovpnserver`: deprioritized: sink exists but no attacker-controlled parameter is identified; auth=unknown; evidence=L2; score=16
- `class/net/ovpnserver/queues/rx-0/rps_cpus`: deprioritized: sink exists but no attacker-controlled parameter is identified; auth=unknown; evidence=L2; score=16
...
- `cloud` (tcp, outbound): auth=device, risk=high; source=`www/fonts/iconfont.a098d098.ttf`; evidence=service marker present
...
- `99-openvpn-irq: ipq53xx_openvpn_irq`
- `99-openvpn-irq: ipq53xx_openvpn_irq()`
...
- Executables/scripts discovered: 1107
...
- Startup candidates: etc/init.d/adguardhome, etc/init.d/at_cache_init, etc/init.d/avahi-daemon, etc/init.d/boot, etc/init.d/bootcount, etc/init.d/carrier-monitor, etc/init.d/cron, etc/init.d/dbus
...
Structured zero-day triage JSON: `known_firmware/reports/GL.iNet_GL-AXT1800_Slate_AX/axt1800-4.8.3_release1-815-0413-1776065915.tar.zero-day.json`

## Extraction Notes

- binwalk -eM --directory known_firmware/extracted/fdb284e1ac9886b7 stopped: extraction exceeded 768 MB: WARNING: Symlink points outside of the extraction directory: /home/jordan/FRIDAY/known_firmware/extracted/fdb284e1ac9886b7/_axt1800-4.8.3_release1-815-0413-1776065915.tar.extracted/sysupgrade-glinet_axt1800/_root.extracted/squashfs-root/usr/bin/ssh -> /usr/sbin/dropbear; changing link target to /dev/null for security purposes.

## Decompiler Notes

- /home/jordan/Tools/ghidra_12.1.2_PUBLIC/support/analyzeHeadless known_firmware/ghidra_projects GL.iNet_GL-AXT1800_Slate_AX_fdb284e1 -import exited 0: OpenJDK 64-Bit Server VM (build 21.0.11+10-1-22.04.2-Ubuntu, mixed mode)
- /home/jordan/Tools/ghidra_12.1.2_PUBLIC/support/analyzeHeadless known_firmware/ghidra_projects GL.iNet_GL-AXT1800_Slate_AX_fdb284e1 -import exited 0: OpenJDK 64-Bit Server VM (build 21.0.11+10-1-22.04.2-Ubuntu, mixed mode)
- /home/jordan/Tools/ghidra_12.1.2_PUBLIC/support/analyzeHeadless known_firmware/ghidra_projects GL.iNet_GL-AXT1800_Slate_AX_fdb284e1 -import exited 0: OpenJDK 64-Bit Server VM (build 21.0.11+10-1-22.04.2-Ubuntu, mixed mode)
- /home/jordan/Tools/ghidra_12.1.2_PUBLIC/support/analyzeHeadless known_firmware/ghidra_projects GL.iNet_GL-AXT1800_Slate_AX_fdb284e1 -import exited 0: OpenJDK 64-Bit Server VM (build 21.0.11+10-1-22.04.2-Ubuntu, mixed mode)
- /home/jordan/Tools/ghidra_12.1.2_PUBLIC/support/analyzeHeadless known_firmware/ghidra_projects GL.iNet_GL-AXT1800_Slate_AX_fdb284e1 -import exited 0: OpenJDK 64-Bit Server VM (build 21.0.11+10-1-22.04.2-Ubuntu, mixed mode)
