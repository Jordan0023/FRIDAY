...
- `files/GDC/RAXE300/RAXE300-V1.0.9.82.zip`: rejected: route is not correlated with a dangerous sink; auth=unknown; evidence=L1; score=7
...
- `mesh` (unknown, lan/wireless): auth=device, risk=high; source=`_RAXE300-V1.0.9.82.zip.extracted/RAXE300-V1.0.9.82_Release_Notes.htm`; evidence=service marker present
...
- `_RAXE300-V1.0.9.82.zip.extracted/7505AD`: L2-co-located, score 33; sources=nvram_get; sinks=file_write, unsafe_memory
- `_RAXE300-V1.0.9.82.zip.extracted/80B850`: L2-co-located, score 33; sources=getenv; sinks=file_write, unsafe_memory
- `_RAXE300-V1.0.9.82.zip.extracted/82CE96`: L2-co-located, score 33; sources=getenv; sinks=file_write, unsafe_memory

### Ghidra Function-local Evidence

- `7BCE05:FUN_000116bc` at `000116bc`: route `/dev/i2c/%d`, sink `file_write`
- `7BCE05:FUN_000116bc` at `000116bc`: route `/dev/i2c/%d`, sink `unsafe_copy`
- `7BCE05:FUN_000116bc` at `000116bc`: route `/dev/i2c-%d`, sink `file_write`
- `7BCE05:FUN_000116bc` at `000116bc`: route `/dev/i2c-%d`, sink `unsafe_copy`
- `7BCE05:FUN_000117fc` at `000117fc`: route `/proc/bus/i2c`, sink `file_write`
- `7BCE05:FUN_000117fc` at `000117fc`: route `/proc/bus/i2c`, sink `unsafe_copy`
- `7BCE05:FUN_000117fc` at `000117fc`: route `/proc/bus/i2c`, sink `unsafe_copy`
- `7BCE05:FUN_000117fc` at `000117fc`: route `/proc/mounts`, sink `file_write`
- `7BCE05:FUN_000117fc` at `000117fc`: route `/proc/mounts`, sink `unsafe_copy`
- `7BCE05:FUN_000117fc` at `000117fc`: route `/proc/mounts`, sink `unsafe_copy`
- `7BCE05:FUN_000117fc` at `000117fc`: route `/%s/name`, sink `file_write`
- `7BCE05:FUN_000117fc` at `000117fc`: route `/%s/name`, sink `unsafe_copy`
- `7BCE05:FUN_000117fc` at `000117fc`: route `/%s/name`, sink `unsafe_copy`
- `7BCE05:FUN_000117fc` at `000117fc`: route `/%s/device/name`, sink `file_write`
- `7BCE05:FUN_000117fc` at `000117fc`: route `/%s/device/name`, sink `unsafe_copy`
- `7BCE05:FUN_000117fc` at `000117fc`: route `/%s/device/name`, sink `unsafe_copy`
- `7BCE05:FUN_000117fc` at `000117fc`: route `/%s/device`, sink `file_write`
- `7BCE05:FUN_000117fc` at `000117fc`: route `/%s/device`, sink `unsafe_copy`
- `7BCE05:FUN_000117fc` at `000117fc`: route `/%s/device`, sink `unsafe_copy`
- `7BCE05:FUN_000117fc` at `000117fc`: route `/%s/device/%s/name`, sink `file_write`
- `7BCE05:FUN_000117fc` at `000117fc`: route `/%s/device/%s/name`, sink `unsafe_copy`
- `7BCE05:FUN_000117fc` at `000117fc`: route `/%s/device/%s/name`, sink `unsafe_copy`
...
- Architectures: arm
- Executables/scripts discovered: 11
...
Structured zero-day triage JSON: `known_firmware/reports/RAXE300/RAXE300-V1.0.9.82.zip.zero-day.json`

## Extraction Notes

- binwalk -eM --directory known_firmware/extracted/08e53e0924044be5 stopped: extraction exceeded 768 MB

## Decompiler Notes

- /home/jordan/Tools/ghidra_12.1.2_PUBLIC/support/analyzeHeadless known_firmware/ghidra_projects RAXE300_08e53e09 -import exited 0: OpenJDK 64-Bit Server VM (build 21.0.11+10-1-22.04.2-Ubuntu, mixed mode)
- /home/jordan/Tools/ghidra_12.1.2_PUBLIC/support/analyzeHeadless known_firmware/ghidra_projects RAXE300_08e53e09 -import exited 0: OpenJDK 64-Bit Server VM (build 21.0.11+10-1-22.04.2-Ubuntu, mixed mode)
- /home/jordan/Tools/ghidra_12.1.2_PUBLIC/support/analyzeHeadless known_firmware/ghidra_projects RAXE300_08e53e09 -import exited 0: OpenJDK 64-Bit Server VM (build 21.0.11+10-1-22.04.2-Ubuntu, mixed mode)
- /home/jordan/Tools/ghidra_12.1.2_PUBLIC/support/analyzeHeadless known_firmware/ghidra_projects RAXE300_08e53e09 -import exited 0: OpenJDK 64-Bit Server VM (build 21.0.11+10-1-22.04.2-Ubuntu, mixed mode)
- /home/jordan/Tools/ghidra_12.1.2_PUBLIC/support/analyzeHeadless known_firmware/ghidra_projects RAXE300_08e53e09 -import exited 0: OpenJDK 64-Bit Server VM (build 21.0.11+10-1-22.04.2-Ubuntu, mixed mode)
