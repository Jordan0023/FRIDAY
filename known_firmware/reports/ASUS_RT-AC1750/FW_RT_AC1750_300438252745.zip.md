...
- Parameters: ClientList_Block_PC, FormTitle, Loading, TargetList_Block_PC, TopBanner, WAN_access_hint, access_port_title, access_ssh, access_telnet, access_webui, accessfromwan_port, action_mode
- Matched risk keywords: none
- Next checks: map route to handler and auth gate; trace each risky parameter into command/file/memory sinks; prove or reject parameter-to-system/popen/exec flow
...
- `Advanced_Feedback.asp: desclist.push(["<#384#>","Firewall"]); //20`
...
Structured zero-day triage JSON: `known_firmware/reports/ASUS_RT-AC1750/FW_RT_AC1750_300438252745.zip.zero-day.json`

## Extraction Notes

- Using existing extraction directory: known_firmware/extracted/cb153f7eaf91461e
