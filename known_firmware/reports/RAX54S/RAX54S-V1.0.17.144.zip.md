...
- `40/80/160MHz`: rejected: route is not correlated with a dangerous sink; auth=unknown; evidence=L0; score=2
- `40/80MHz`: rejected: route is not correlated with a dangerous sink; auth=unknown; evidence=L0; score=2
...
- `files/GDC/RAX54S/RAX54S-V1.0.17.144.zip`: rejected: route is not correlated with a dangerous sink; auth=unknown; evidence=L0; score=2
- `passive/home`: rejected: route is not correlated with a dangerous sink; auth=unknown; evidence=L0; score=2
- `run/netns`: rejected: route is not correlated with a dangerous sink; auth=unknown; evidence=L0; score=2
- `self/ns/net`: rejected: route is not correlated with a dangerous sink; auth=unknown; evidence=L0; score=2
- `5g/6g`: deprioritized: authenticated administrator or privileged session required; auth=required; evidence=L0; score=-15

### Non-HTTP Service Surface

- `telnetd` (tcp, lan): auth=unknown, risk=high; source=`_RAX54S-V1.0.17.144.zip.extracted/363EA5`; evidence=service marker present
...
- `_RAX54S-V1.0.17.144.zip.extracted/3DC062`: L2-co-located, score 28; sources=getenv; sinks=unsafe_memory
...
- Architectures: arm
- Executables/scripts discovered: 3
...
Structured zero-day triage JSON: `known_firmware/reports/RAX54S/RAX54S-V1.0.17.144.zip.zero-day.json`

## Extraction Notes

- binwalk -eM --directory known_firmware/extracted/12d0be80c7dfee7f stopped: extraction exceeded 768 MB

## Decompiler Notes

- /home/jordan/Tools/ghidra_12.1.2_PUBLIC/support/analyzeHeadless known_firmware/ghidra_projects RAX54S_12d0be80 -import exited 0: OpenJDK 64-Bit Server VM (build 21.0.11+10-1-22.04.2-Ubuntu, mixed mode)
- /home/jordan/Tools/ghidra_12.1.2_PUBLIC/support/analyzeHeadless known_firmware/ghidra_projects RAX54S_12d0be80 -import exited 0: OpenJDK 64-Bit Server VM (build 21.0.11+10-1-22.04.2-Ubuntu, mixed mode)
- /home/jordan/Tools/ghidra_12.1.2_PUBLIC/support/analyzeHeadless known_firmware/ghidra_projects RAX54S_12d0be80 -import exited 0: OpenJDK 64-Bit Server VM (build 21.0.11+10-1-22.04.2-Ubuntu, mixed mode)
