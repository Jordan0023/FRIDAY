...
- Parameters: DNS1, DNS2, WANIP, connectbutton, connectbutton_link, connectbutton_nolink, connectionType, connectstatus, gateway, internetForm, yadns_ctrl, yadns_mode
...
- `Advanced_ACL_Content.asp: <a class="hintstyle" href="javascript:void(0);" onClick="openHint(18,5);"><#FirewallConfig_MFMethod_itemname#></a>`
...
- `Advanced_BasicFirewall_Content.asp: <option value="accept" <% nvram_match_x("FirewallConfig","fw_log_x", "accept","selected"); %>><#checkbox_Accepted#></option>`
- `Advanced_BasicFirewall_Content.asp: <option value="both" <% nvram_match_x("FirewallConfig","fw_log_x", "both","selected"); %>><#checkbox_Both#></option>`
- `Advanced_BasicFirewall_Content.asp: <option value="drop" <% nvram_match_x("FirewallConfig","fw_log_x", "drop","selected"); %>><#checkbox_Dropped#></option>`
- `Advanced_BasicFirewall_Content.asp: <option value="none" <% nvram_match_x("FirewallConfig","fw_log_x", "none","selected"); %>><#checkbox_None#></option>`
...
Structured zero-day triage JSON: `known_firmware/reports/ASUS_RT-N10_Ver._B/FW_RT_N10Plus_2034.zip.zero-day.json`

## Extraction Notes

- Using existing extraction directory: known_firmware/extracted/cfe96ae5f3e00fa4
