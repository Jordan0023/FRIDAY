...
- `about/security`: rejected: route is not correlated with a dangerous sink; auth=unknown; evidence=L0; score=7
- `files/GDC/EX6470/EX6470-V1.0.3.34.zip`: rejected: route is not correlated with a dangerous sink; auth=unknown; evidence=L0; score=7
...
Structured zero-day triage JSON: `known_firmware/reports/EX6470/EX6470-V1.0.3.34.zip.zero-day.json`

## Extraction Notes

- Using existing extraction directory: known_firmware/extracted/ebd044ecf8135b9e
