...
- `mesh` (unknown, lan/wireless): auth=device, risk=high; source=`_XR1000-V1.0.2.86.zip.extracted/XR1000-V1.0.2.86_Release_Notes.htm`; evidence=service marker present
- `telnetd` (tcp, lan): auth=unknown, risk=high; source=`_XR1000-V1.0.2.86.zip.extracted/34C6AC`; evidence=service marker present
...
Structured zero-day triage JSON: `known_firmware/reports/XR1000/XR1000-V1.0.2.86.zip.zero-day.json`

## Extraction Notes

- binwalk -eM --directory known_firmware/extracted/7b082abc417e8898 stopped: extraction exceeded 768 MB
