...
- Parameters: action_mode, action_script, action_wait, current_page, error_status_field, foilautofill, form, group_id, hidden_frame, login_authorization, login_filed, login_passwd
- Matched risk keywords: none
- Next checks: map route to handler and auth gate; trace each risky parameter into command/file/memory sinks; prove or reject parameter-to-system/popen/exec flow
...
- `Advanced_Feedback.asp: desclist.push(["<#196#>","Firewall"]); //20`
...
Structured zero-day triage JSON: `known_firmware/reports/ASUS_RT-N12K/FW_RT_N12K_30043788079.zip.zero-day.json`

## Extraction Notes

- Using existing extraction directory: known_firmware/extracted/890175f2b81a3eab
