...
- `spool/sms/failed`: deprioritized: sink exists but no attacker-controlled parameter is identified; auth=unknown; evidence=L2; score=17
- `sys/net`: deprioritized: sink exists but no attacker-controlled parameter is identified; auth=unknown; evidence=L2; score=17
- `cgi-bin/cgi-upload`: rejected: route is not correlated with a dangerous sink; auth=unknown; evidence=L0; score=16
- `class/net/ovpnclient`: deprioritized: sink exists but no attacker-controlled parameter is identified; auth=unknown; evidence=L2; score=16
...
- `kernel/debug/ath11k/qcn6122_1/mac0/fw_stats/pdev_stats`: deprioritized: sink exists but no attacker-controlled parameter is identified; auth=unknown; evidence=L2; score=14
- `kernel/debug/ath11k/qcn6122_2/mac0/fw_stats/pdev_stats`: deprioritized: sink exists but no attacker-controlled parameter is identified; auth=unknown; evidence=L2; score=14
- `kernel/debug/qca-nss-drv/stats/pppoe`: deprioritized: sink exists but no attacker-controlled parameter is identified; auth=unknown; evidence=L2; score=14
- `mptun/debugip`: rejected: route is not correlated with a dangerous sink; auth=unknown; evidence=L0; score=14
- `run/dnsmasq/dnsmasq.ovpnclient`: rejected: route is not correlated with a dangerous sink; auth=unknown; evidence=L0; score=14
- `run/dnsmasq_vpn`: deprioritized: sink exists but no attacker-controlled parameter is identified; auth=unknown; evidence=L2; score=14
...
- `cloud` (tcp, outbound): auth=device, risk=high; source=`www/fonts/iconfont.f8a8ace6.ttf`; evidence=service marker present
...
- `cgi-fcgi:FUN_004016c4` at `004016c4`: route `/*`, sink `file_write`
- `cgi-fcgi:FUN_004016c4` at `004016c4`: route `/*`, sink `unsafe_copy`
- `cgi-fcgi:FUN_00401c98` at `00401c98`: route `/*`, sink `memory_operation`
...
- Architectures: aarch64, elf-164, elf-3, script
- Executables/scripts discovered: 1124
...
- Startup candidates: etc/init.d/adguardhome, etc/init.d/at_cache_init, etc/init.d/avahi-daemon, etc/init.d/boot, etc/init.d/bootcount, etc/init.d/carrier-monitor, etc/init.d/chronyd, etc/init.d/cron
...
Structured zero-day triage JSON: `known_firmware/reports/GL.iNet_GL-AX1800_Flint/ax1800-4.8.3_release2-930-1226-1766712814.tar.zero-day.json`

## Extraction Notes

- binwalk -eM --directory known_firmware/extracted/a1aae18b9a7da1fc stopped: extraction exceeded 768 MB: WARNING: Symlink points outside of the extraction directory: /home/jordan/FRIDAY/known_firmware/extracted/a1aae18b9a7da1fc/_ax1800-4.8.3_release2-930-1226-1766712814.tar.extracted/sysupgrade-glinet_ax1800/_root.extracted/squashfs-root/usr/bin/ssh -> /usr/sbin/dropbear; changing link target to /dev/null for security purposes.

## Decompiler Notes

- /home/jordan/Tools/ghidra_12.1.2_PUBLIC/support/analyzeHeadless known_firmware/ghidra_projects GL.iNet_GL-AX1800_Flint_a1aae18b -import exited 0: OpenJDK 64-Bit Server VM (build 21.0.11+10-1-22.04.2-Ubuntu, mixed mode)
- /home/jordan/Tools/ghidra_12.1.2_PUBLIC/support/analyzeHeadless known_firmware/ghidra_projects GL.iNet_GL-AX1800_Flint_a1aae18b -import exited 0: OpenJDK 64-Bit Server VM (build 21.0.11+10-1-22.04.2-Ubuntu, mixed mode)
- /home/jordan/Tools/ghidra_12.1.2_PUBLIC/support/analyzeHeadless known_firmware/ghidra_projects GL.iNet_GL-AX1800_Flint_a1aae18b -import exited 0: OpenJDK 64-Bit Server VM (build 21.0.11+10-1-22.04.2-Ubuntu, mixed mode)
- /home/jordan/Tools/ghidra_12.1.2_PUBLIC/support/analyzeHeadless known_firmware/ghidra_projects GL.iNet_GL-AX1800_Flint_a1aae18b -import exited 0: OpenJDK 64-Bit Server VM (build 21.0.11+10-1-22.04.2-Ubuntu, mixed mode)
- /home/jordan/Tools/ghidra_12.1.2_PUBLIC/support/analyzeHeadless known_firmware/ghidra_projects GL.iNet_GL-AX1800_Flint_a1aae18b -import exited 0: OpenJDK 64-Bit Server VM (build 21.0.11+10-1-22.04.2-Ubuntu, mixed mode)
