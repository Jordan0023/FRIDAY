...
- `files/GDC/BE9300/BE9300-V1.0.6.16.zip`: rejected: route is not correlated with a dangerous sink; auth=unknown; evidence=L0; score=2
...
- `_BE9300-V1.0.6.16.zip.extracted/738992`: L2-co-located, score 33; sources=getenv; sinks=file_write, unsafe_memory
...
- Architectures: arm
- Executables/scripts discovered: 2
...
Structured zero-day triage JSON: `known_firmware/reports/BE9300/BE9300-V1.0.6.16.zip.zero-day.json`

## Extraction Notes

- Using existing extraction directory: known_firmware/extracted/694e29849f8fb89d

## Decompiler Notes

- /home/jordan/Tools/ghidra_12.1.2_PUBLIC/support/analyzeHeadless known_firmware/ghidra_projects BE9300_694e2984 -import exited 0: OpenJDK 64-Bit Server VM (build 21.0.11+10-1-22.04.2-Ubuntu, mixed mode)
- /home/jordan/Tools/ghidra_12.1.2_PUBLIC/support/analyzeHeadless known_firmware/ghidra_projects BE9300_694e2984 -import exited 0: OpenJDK 64-Bit Server VM (build 21.0.11+10-1-22.04.2-Ubuntu, mixed mode)
